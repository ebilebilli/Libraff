...
urlpatterns = [
    ...
    path('book/<int:book_id>/comments/', CommentManagementAPIView.as_view(), name='manage-comments'),
    ...
    path('book/<int:book_id>/comment/<int:comment_id>/detail/', CommentDetailAPIView.as_view(), name='comment-detail'),
    ...
    path('book/<int:book_id>/like/manage/', LikeManagementForBookAPIView.as_view(), name='manage-like-for-book'),
    path('comment/<int:comment_id>/like/manage/', LikeManagementForCommentAPIView.as_view(), name='manage-like-for-comment'),

    # Favorit endpoint-ləri:
    path('user/<int:user_id>/favorites/open/', OpenFavoriteListForUserAPIView.as_view(), name='open-favorites-for-user'),
    path('user/<int:user_id>/favorites/private/', PrivateFavoriteListForUserAPIView.as_view(), name='private-favorites-for-user'),
    ...
    path('favorite/<int:favorite_id>/manage/', FavoriteManagementAPIView.as_view(), name='manage-favorite'),
